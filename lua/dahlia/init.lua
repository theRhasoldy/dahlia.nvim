...
function dahlia.highlight(name, definition) -- {{{
...
function dahlia.highlight_all(groups)
  for name, _ in pairs(groups) do
    dahlia.highlight(name, resolve(groups, name, false))
  end
end
...
function dahlia.highlight_terminal(terminal_colors)
